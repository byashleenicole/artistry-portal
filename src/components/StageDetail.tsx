  ...
  return (
    <div style={styles.page}>
      <div style={styles.inner}>
        ...
        {loading && (
          <div style={styles.emptyAssets}>Loading assets...</div>
        )}
        ...
        {!approved && !loading && (
          <div style={styles.approveSection}>
            ...
            <div style={styles.approveSub}>
              Approving this stage confirms you're happy with the work and ready for the next phase.
            </div>
            <button
